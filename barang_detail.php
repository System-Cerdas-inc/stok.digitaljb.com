            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Stok keluar</b> <a class="pull-right"><?php echo $terjual;?></a>
                </li>
                <li class="list-group-item">
                  <b>Stok Masuk</b> <a class="pull-right"><?php echo $terbeli;?></a>
                </li>
                <li class="list-group-item">
                  <b>Stok Available</b> <a class="pull-right"><?php echo $sisa;?></a>
                </li>
              </ul>

              <a href="stok_sesuaikan" class="btn btn-primary btn-block"><b>Penyesuaian Stok</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<div class="tab-pane" id="settings">
                <form class="form-horizontal"  >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="inputExperience" readonly="readonly" ><?php echo $keterangan;?></textarea>
                    </div>
                  </div>

...
$no=$_GET['no'];
 ...
 ?>
         ...
         <div class="form-group">
                  <label for="menu3" class="col-sm-3 control-label">Menu Atribut Barang</label>
                  <div class="col-sm-9">
         ...
         <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Menu Aktivitas</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="menu5" name="menu5" placeholder="Masukkan Hak Akses" value="<?php echo $menu5; ?>" maxlength="1">
                      ...
                      <input type="hidden" class="form-control" id="menu6" name="menu6" placeholder="Masukkan Hak Akses" value="<?php echo $menu6; ?>" maxlength="1">
                

               
                     <input type="hidden" class="form-control" id="menu7" name="menu7" placeholder="Masukkan Hak Akses" value="<?php echo $menu7; ?>" maxlength="1">
  ...
  $menu11 = $_POST['menu11'];
        ...
        if(isset($_POST['simpan'])){
           ...
           $sql1 = "update chmenu set menu1='$menu1', menu2='$menu2', menu3='$menu3', menu4='$menu4', menu5='$menu5', menu6='$menu6', menu7='$menu7', menu8='$menu8',menu9='$menu9',menu10='$menu10',menu11='$menu11' where userjabatan = '$userjabatan'";
             ...
             echo "<script type='text/javascript'>  alert('Hak Akses Jabatan telah diupdate!'); </script>";

          ...
          if (isset($_POST["truncate"])) {
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                $trun1 = mysqli_query($conn, 'TRUNCATE TABLE barang_detil ');
                    ...
                    <form class="form-horizontal" method="post">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="url" name="url" placeholder="Masukan URL dengan http://" value="<?php echo $url; ?>" maxlength="100"><b>Contoh:</b> http://localhost/indotory atau http://fymamedia.com<br> disesuaikan URL instalasi anda
                          </div>
                        </div>
